...
export default function Register() {
  ...
  return (
    <div className="bg-slate-50 py-16 px-4 flex justify-center items-center">
      <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-xl max-w-xl w-full flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Open An Account</h2>
