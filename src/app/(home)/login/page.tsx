...
export default function Login() {
  ...
  return (
    <div className="bg-slate-50 min-h-[80vh] py-16 px-4 flex justify-center items-center">
      <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-xl max-w-md w-full flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Access National</h2>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex justify-between items-center">
              ...
              <Link href="/faq" className="text-xs text-primary hover:underline">Forgot?</Link>
            </div>
            <div className="relative">
